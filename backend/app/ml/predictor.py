...
class LoanPredictorEngine:
    ...
    def predict(self, input_data: dict) -> dict:
        ...
        loan_tenure = int(input_data.get("LoanTenure") or input_data.get("loanTenure") or input_data.get("loanTerm") or 36)
        ...
        credit_card_usage = float(input_data.get("CreditCardUsage") or input_data.get("creditCardUsage") or 0.3)
