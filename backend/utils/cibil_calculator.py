...
def calculate_cibil_score(
    ...
    if credit_utilization_pct <= 10: util_points = 180.0
    elif credit_utilization_pct <= 30: util_points = 160.0
    elif credit_utilization_pct <= 50: util_points = 110.0
    elif credit_utilization_pct <= 70: util_points = 70.0
    else: util_points = 30.0
